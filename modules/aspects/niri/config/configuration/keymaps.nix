    ...
    homeManager = { config, ... }: {
      xdg.configFile."niri/configuration/keymaps.kdl".text = ''
        binds {
            ...
            Mod+Shift+Return hotkey-overlay-title="Run an Application: ${user.defaultBrowser}" { spawn "${user.defaultBrowser}"; }
            Mod+Shift+F hotkey-overlay-title="Run an Application: ${user.defaultFileManager}" { spawn "${user.defaultFileManager}"; }
      ...
      + lib.optionalString (lib.attrByPath [ "programs" "noctalia" "enable" ] false config) ''
        Mod+Space hotkey-overlay-title="Run an Application: noctalia-launcher" { spawn-sh "noctalia msg panel-toggle launcher"; }
        Mod+Ctrl+Shift+Space hotkey-overlay-title="Run an Application: noctalia-wallpaper" { spawn-sh "noctalia msg panel-toggle wallpaper"; }
        Mod+Y hotkey-overlay-title="Run an Application: rofi-cliphist" { spawn-sh "noctalia msg panel-toggle clipboard"; }
        Mod+Ctrl+L hotkey-overlay-title="Lock Screen" { spawn-sh "noctalia msg session lock"; }
        Mod+P hotkey-overlay-title="Call powermenu" { spawn-sh "noctalia msg panel-toggle session"; }
